...
public class DogTest {
	...
	Dog Dogy = new Dog("dogy","Bulldog","Confident", "Large","South", "Young", "Avi3", "Male",true, false, true);
	Dog Hetz = new Dog("hetz","Beagle","Independent", "Small", "South", "Young", "Dany5", "Female",true, false, true);
	Dog Bunny = new Dog("bunny","German Shepherd","Independent", "Medium","South", "Young", "David45", "Female",true, true, true);
	Dog Rey = new Dog("rey","Boxer","Shy/Timid", "Small", "Center", "Adult", "Avi3", "Female",false, false, true);
	Dog Bob = new Dog("bob","Bulldog","Independent", "Small", "South", "Young", "David45", "Female",true, false, true);
	Dog Nil = new Dog("nil","Beagle","Independent", "Medium","South", "Young", "David45", "Female",true, true, true);
