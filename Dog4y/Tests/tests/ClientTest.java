...
public class ClientTest {
	...
	public void testisValidPhone() {
		...
		assertFalse("Invalid Phone", testClientRepository.isValidPhone(badPhone));
		assertTrue("Valid Phone", testClientRepository.isValidPhone(goodPhone));
	}
	...
	public void testisValidName() {
		...
		assertFalse("valid name", testClientRepository.isValidName(badName));
		assertTrue("InValid name", testClientRepository.isValidName(goodName));
	}
...
//		aviCohen = ("Avi@gmail.com","avi1","123","Avi","Cohen","Tel-Aviv","0521234567","user")
		...
		assertFalse("exist", testClientRepository.isUserNameExist("avi1"));
	}
